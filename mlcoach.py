...
try:
    ...
    Instruction    = ""
    Instruction_c1 = "  Розпочинаємо заняття! Права рука   "
    Instruction_c2 = "     10 згиннань на біцепс        "
    ...
    while True:
        ...
        try:
            ...
            if right_hand:
                ...
                if not reps == 0 or not hand_pos == 0:
                    if 0 not in [b_angle, ra_angle] and abs(b_angle - ra_angle) >= 10:
                        if bad_pos > 5:     
                            Instruction_c2 = "Будь ласка, тримайте плече рівно"
                        else:
                            bad_pos+=1
                    else:
                        Instruction_c2 = ""
            ...
            if abs(90 - b_angle) >= 10:
                Instruction_c2 = "    Будь ласка, вирівняйте спину    "

            if reps==10 and right_hand:
                reps = 0
                Instruction_c1 = "Вправа на праву руку закінчена."
                Instruction_c2 = " Тепер зробимо 10 повторень на ліву руку."
                right_hand = False
            elif reps==10 and not right_hand:
                reps = 0
                sets+=1
                Instruction_c1="      Зроблено "+str(sets)+" підходів      "
                Instruction_c2="  Тепер зробимо 10 повторень на праву руку.  "
                right_hand = True
            ...
            #cv2.putText(op_img, "Angle: " + "%.2f" % angle , (20,30),   font, 0.8,(0,0,255),2,cv2.LINE_AA)
            cv2.putText(op_img, "Повторення: " + str(reps), (20,50),   font, 1.2,(0,0,255),3,cv2.LINE_AA)
            cv2.putText(op_img, "Підходи:        " + str(sets), (20,110),  font, 1.2,(0,0,255),3,cv2.LINE_AA)
            #cv2.putText(op_img, "Back Angle: " + "%.2f" % b_angle , (20,150),   font, 0.8,(0,0,255),2,cv2.LINE_AA)
            #cv2.putText(op_img, "Hand : " + "%.2f" % (ra_angle) , (20,190),   font, 0.8,(0,0,255),2,cv2.LINE_AA)
        ...
        out.write(op_img)
        cv2.imshow("Розумний помічник - Згинання на біцепс", op_img)
